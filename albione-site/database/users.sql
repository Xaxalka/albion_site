...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `email_verified_at`, `password`, `is_admin`, `remember_token`, `created_at`, `updated_at`) VALUES
  (1, 'Test User', 'testuser', 'test@example.com', '2024-01-01 00:00:00', '$2y$12$oAjM5upvUDsqF/Mc00cq1.OpeU/Y4AnyG/GIC7Mpj1Damn9t4v1O2', 1, NULL, '2024-01-01 00:00:00', '2024-01-01 00:00:00'),
