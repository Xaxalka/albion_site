        ...
        <div class="tags mt-8">
            <template x-for="level in enchantments" :key="level">
                <button
                    ...
                    :class="selectedEnchant === level ? 'btn' : 'chip'"
                >
                    <span class="chip" :class="selectedEnchant === level ? 'chip-active' : ''">+<span x-text="level"></span></span>
                </button>
            </template>
        </div>
    </div>
